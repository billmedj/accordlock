...
const baseTokens: Pick<ThemeTokens, BaseTokenKey> = {
  // Typography — families
  '--font-sans':
    'ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI Variable", "Segoe UI", Helvetica, Arial, sans-serif',
...
// AccordLock intentionally uses local system fonts. Sandboxed MCP apps inherit
// the same stack without making a network request during rendering.
const HOST_FONT_CSS = '';
