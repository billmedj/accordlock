...
const i18n = defineMessages({
  ...
  templateVarHint: {
    ...
    defaultMessage: "Use '{{parameter_name}}' for values entered at run time.",
  },
  initialPrompt: {
  ...
  promptOptionalHint: {
    ...
    defaultMessage: 'Optional if instructions are set',
  },
  promptPlaceholder: {
    id: 'recipeFormFields.promptPlaceholder',
    defaultMessage: 'Prompt sent when the playbook starts',
  },
  advancedOptions: {
  ...
  advancedOptionsHint: {
    ...
    defaultMessage: 'Prompts, parameters, model, tools, output, nested playbooks',
  },
  parametersLabel: {
  ...
  parametersDescription: {
    ...
    defaultMessage: "Parameters in '{{parameter_name}}' format appear here automatically.",
  },
  ...
  responseJsonSchemaDescription: {
    ...
    defaultMessage: 'Require a JSON Schema response',
  },
});
