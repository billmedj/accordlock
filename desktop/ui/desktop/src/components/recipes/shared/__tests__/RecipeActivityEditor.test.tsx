...
describe('RecipeActivityEditor', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('shows helper text', () => {
      renderWithIntl(<RecipeActivityEditor activities={[]} setActivities={mockOnChange} />);
      expect(
        screen.getByText('Suggested prompts shown when the playbook opens.')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Empty State', () => {
    it('shows message input when no activities', () => {
      ...
      expect(screen.getByPlaceholderText('Introduction message…')).toBeInTheDocument();
    });
  });
  ...
  describe('With Activities', () => {
    it('displays existing activities as visual boxes', () => {
      ...
      const messageTextarea = screen.getByPlaceholderText('Introduction message…');
