...
const i18n = defineMessages({
  title: {
    ...
    defaultMessage: 'New nested playbook',
  },
  subtitle: {
    id: 'createSubRecipeInline.subtitle',
    defaultMessage: 'Use one playbook as a tool inside another.',
  },
  closeModal: {
    id: 'createSubRecipeInline.closeModal',
    defaultMessage: 'Close new nested playbook',
  },
  nameLabel: {
  ...
  instructionsPlaceholder: {
    ...
    defaultMessage: 'Instructions for the nested playbook…',
  },
  ...
  preconfiguredValues: {
    ...
    defaultMessage: 'Preconfigured values',
  },
  preconfiguredValuesHint: {
    id: 'createSubRecipeInline.preconfiguredValuesHint',
    defaultMessage: 'Values passed to every run',
  },
  cancel: {
  ...
  validationMsg: {
    ...
    defaultMessage: 'Add a name, title, description, and instructions.',
  },
  duplicateName: {
  ...
  duplicateNameMsg: {
    ...
    defaultMessage: 'A nested playbook named "{name}" already exists.',
  },
  createdSuccess: {
    id: 'createSubRecipeInline.createdSuccess',
    defaultMessage: 'Nested playbook created',
  },
  saveFailed: {
    id: 'createSubRecipeInline.saveFailed',
    defaultMessage: 'Could not save nested playbook',
  },
  saveFailedMsg: {
