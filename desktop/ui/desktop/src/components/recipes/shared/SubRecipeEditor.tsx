...
const i18n = defineMessages({
  label: {
    ...
    defaultMessage: 'Nested playbooks',
  },
  createNew: {
  ...
  description: {
    ...
    defaultMessage: 'Run one playbook as a tool inside another.',
  },
  sequential: {
  ...
  editSubrecipe: {
    ...
    defaultMessage: 'Edit nested playbook {name}',
  },
  deleteSubrecipe: {
    id: 'subRecipeEditor.deleteSubrecipe',
    defaultMessage: 'Delete nested playbook {name}',
  },
  duplicateName: {
