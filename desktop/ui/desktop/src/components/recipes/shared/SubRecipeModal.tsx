...
const i18n = defineMessages({
  configureTitle: {
    ...
    defaultMessage: 'Edit nested playbook',
  },
  addTitle: {
    id: 'subRecipeModal.addTitle',
    defaultMessage: 'Add nested playbook',
  },
  subtitle: {
    id: 'subRecipeModal.subtitle',
    defaultMessage: 'Run this playbook as a tool inside another.',
  },
  closeModal: {
    id: 'subRecipeModal.closeModal',
    defaultMessage: 'Close nested playbook',
  },
  nameLabel: {
  ...
  pathPlaceholder: {
    ...
    defaultMessage: 'e.g., ./playbooks/security-analysis.yaml',
  },
  browse: {
  ...
  pathHint: {
    ...
    defaultMessage: 'Choose a playbook file or enter its path',
  },
  descriptionLabel: {
  ...
  sequentialHint: {
    ...
    defaultMessage: 'Run repeated calls one at a time',
  },
  preconfiguredValues: {
