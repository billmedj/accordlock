...
const i18n = defineMessages({
  ...
  activitiesDescription: {
    ...
    defaultMessage: 'Suggested prompts shown when the playbook opens.',
  },
  messageLabel: {
  ...
  messageDescription: {
    ...
    defaultMessage: 'A message shown above the prompt buttons. Markdown is supported.',
  },
  messagePlaceholder: {
