...
const i18n = defineMessages({
  ...
  createSubtitle: {
    ...
    defaultMessage: 'Run recurring work from a saved setup.',
  },
  editSubtitle: {
    id: 'createEditRecipe.editSubtitle',
    defaultMessage: 'Changes apply the next time this playbook runs.',
  },
  copyLinkDescription: {
    id: 'createEditRecipe.copyLinkDescription',
    defaultMessage: 'Anyone with this link can import the playbook.',
  },
  copied: {
  ...
  generatingDeeplink: {
    ...
    defaultMessage: 'Creating share link...',
  },
  ...
  validationFailed: {
    ...
    defaultMessage: 'Check required fields',
  },
  validationMsg: {
    id: 'createEditRecipe.validationMsg',
    defaultMessage: 'Complete the required fields and check the JSON schema.',
  },
  recipeSavedMsg: {
    id: 'createEditRecipe.recipeSavedMsg',
    defaultMessage: 'Playbook saved',
  },
  saveFailed: {
    id: 'createEditRecipe.saveFailed',
    defaultMessage: 'Could not save playbook',
  },
  saveFailedMsg: {
  ...
  recipeSavedAndLaunchedMsg: {
    ...
    defaultMessage: 'Playbook started',
  },
  saveAndRunFailed: {
    id: 'createEditRecipe.saveAndRunFailed',
    defaultMessage: 'Could not start playbook',
  },
  saveAndRunFailedMsg: {
...
export default function CreateEditRecipeModal({
  ...
  useEffect(() => {
    ...
    const generateLink = async () => {
      ...
      try {
        ...
        console.error('Failed to generate playbook share link:', error);
        if (!isCancelled) {
          setDeeplink('Could not create share link');
        }
      } finally {
        if (!isCancelled) {
  ...
  const handleCopy = () => {
    if (!deeplink || isGeneratingDeeplink || deeplink === 'Could not create share link') {
      return;
    }
      ...
      <div className="bg-background-primary border border-border-primary rounded-lg w-[90vw] max-w-4xl h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border-primary">
          <div className="flex items-center gap-3">
            <AccordLockGlyph className="size-8 rounded-full shadow-none" />
            <div>
            ...
            <div className="w-full p-4 bg-background-secondary rounded-lg mt-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  ...
                  size="sm"
                  disabled={
                    !deeplink || isGeneratingDeeplink || deeplink === 'Could not create share link'
                  }
