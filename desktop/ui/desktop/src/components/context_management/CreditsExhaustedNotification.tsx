...
const TRUSTED_BILLING_HOSTS = new Set(['router.tetrate.ai']);
...
export function getValidatedTopUpUrl(data: unknown): string | null {
  ...
  try {
    ...
    if (parsedUrl.protocol !== 'https:' || !TRUSTED_BILLING_HOSTS.has(parsedUrl.hostname)) {
      return null;
    }
