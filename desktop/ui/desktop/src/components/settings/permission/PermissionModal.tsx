...
const i18n = defineMessages({
  ...
  noActiveSession: {
    ...
    defaultMessage: 'No active task',
  },
  noActiveSessionDescription: {
    id: 'permissionModal.noActiveSessionDescription',
    defaultMessage: 'Start a task first to manage access for this extension.',
  },
  failedToLoadTools: {
    id: 'permissionModal.failedToLoadTools',
    defaultMessage: 'Couldn’t load available actions',
  },
  failedToLoadToolsDescription: {
    id: 'permissionModal.failedToLoadToolsDescription',
    defaultMessage: 'This extension may not be available in the current task.',
  },
  noToolsAvailable: {
    id: 'permissionModal.noToolsAvailable',
    defaultMessage: 'No actions are available for this extension.',
  },
  close: {
