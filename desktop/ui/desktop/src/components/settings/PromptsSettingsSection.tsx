...
const i18n = defineMessages({
  ...
  promptEditingDescription: {
    ...
    defaultMessage:
      "Customize prompts that define AccordLock's behavior in different contexts. They use Jinja2 templates; changing variables incorrectly can break functionality.",
  },
  resetAll: {
