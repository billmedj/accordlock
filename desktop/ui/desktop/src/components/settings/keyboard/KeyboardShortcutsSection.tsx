...
const i18n = defineMessages({
  ...
  focusWindowLabel: {
    ...
    defaultMessage: 'Focus AccordLock Window',
  },
  focusWindowDescription: {
    id: 'keyboardShortcuts.focusWindowDescription',
    defaultMessage: 'Bring AccordLock to the front from anywhere',
  },
  quickLauncherLabel: {
  ...
  newChatDescription: {
    ...
    defaultMessage: 'Start a new task in the current window',
  },
  newChatWindowLabel: {
    id: 'keyboardShortcuts.newChatWindowLabel',
    defaultMessage: 'New Task Window',
  },
  newChatWindowDescription: {
    id: 'keyboardShortcuts.newChatWindowDescription',
    defaultMessage: 'Open a new AccordLock window',
  },
  openDirectoryLabel: {
  ...
  categoryGlobalDescription: {
    ...
    defaultMessage: 'These shortcuts work system-wide, even when AccordLock is not focused',
  },
  categoryApplication: {
  ...
  categoryApplicationDescription: {
    ...
    defaultMessage: 'These shortcuts work when AccordLock is the active application',
  },
  categorySearch: {
  ...
  restartDescription: {
    ...
    defaultMessage:
      'Changes to application shortcuts (such as New Task and Settings) require restarting AccordLock. Global shortcuts work immediately.',
  },
  dismiss: {
