...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default AccordLock starts its verified local engine. Advanced deployments can connect an ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. AccordLock checks /status and connects to /acp under this base.',
  },
  workingDir: {
  ...
  restartNote: {
    ...
    defaultMessage:
      'Changes apply to new task windows. Restart AccordLock to update existing windows.',
  },
  urlProtocolError: {
