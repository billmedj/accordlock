...
const i18n = defineMessages({
  ...
  onboardingDescription: {
    ...
    defaultMessage:
      'Select the AI model provider AccordLock should use. Keys saved here are stored only in your operating system credential vault and can be changed at any time.',
  },
  loadingProviders: {
