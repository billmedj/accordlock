...
const i18n = defineMessages({
  ...
  addApiKeyDescription: {
    ...
    defaultMessage: 'Add your API key(s) to connect this provider to AccordLock',
  },
  oauthLoginFailed: {
    id: 'providerConfigurationModal.oauthLoginFailed',
    defaultMessage: 'Sign-in could not be completed. Check the provider and try again.',
  },
  parameterRequired: {
  ...
  externalSetupIntro: {
    ...
    defaultMessage: 'This provider is configured outside AccordLock. Follow these steps:',
  },
  chooseModel: {
...
export default function ProviderConfigurationModal({
  ...
  const handleOAuthLogin = async () => {
    ...
    try {
      ...
      setError(intl.formatMessage(i18n.oauthLoginFailed));
    } finally {
  ...
  const handleSubmitForm = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(intl.formatMessage(i18n.errorCheckingConfig));
    }
  };
