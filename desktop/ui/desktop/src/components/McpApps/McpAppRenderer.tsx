...
const i18n = defineMessages({
  ...
  failedToLoadResource: {
    ...
    defaultMessage: "This app couldn't load its content. Try again.",
  },
  failedToInitSandbox: {
  ...
  appFailed: {
    id: 'mcpAppRenderer.appFailed',
    defaultMessage: "This app couldn't continue. Close it and try again.",
  },
});
...
export default function McpAppRenderer({
      ...
      for (let attempt = 0; attempt <= MAX_RETRIES; attempt++) {
        ...
        try {
          ...
          dispatch({
            ...
            message: userFacingErrorMessage(err, intl.formatMessage(i18n.failedToLoadResource)),
          });
          return;
        }
      }
  ...
  const handleError = useCallback(
    (err: Error) => {
      ...
      dispatch({
        type: 'ERROR',
        message: userFacingErrorMessage(err, intl.formatMessage(i18n.appFailed)),
      });
    },
    [intl]
  );
