...
const i18n = defineMessages({
  ...
  editInPlaceTitle: {
    ...
    defaultMessage: 'Update this message in the current task',
  },
  forkSession: {
    id: 'userMessage.forkSession',
    defaultMessage: 'Branch task',
  },
  forkSessionAriaLabel: {
    id: 'userMessage.forkSessionAriaLabel',
    defaultMessage: 'Branch task from the edited message',
  },
  forkSessionTitle: {
    id: 'userMessage.forkSessionTitle',
    defaultMessage: 'Create a new task from the edited message',
  },
  editButton: {
