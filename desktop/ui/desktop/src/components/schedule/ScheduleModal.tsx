...
const i18n = defineMessages({
  ...
  deepLink: { id: 'scheduleModal.deepLink', defaultMessage: 'Share link' },
  browseYaml: { id: 'scheduleModal.browseYaml', defaultMessage: 'Choose YAML file…' },
  selected: { id: 'scheduleModal.selected', defaultMessage: 'Selected: {path}' },
  deepLinkPlaceholder: {
    id: 'scheduleModal.deepLinkPlaceholder',
    defaultMessage: 'Paste an AccordLock share link…',
  },
  recipeParsed: { id: 'scheduleModal.recipeParsed', defaultMessage: 'Playbook ready' },
  ...
  updateSchedule: { id: 'scheduleModal.updateSchedule', defaultMessage: 'Save schedule' },
  createSchedule: { id: 'scheduleModal.createSchedule', defaultMessage: 'Create schedule' },
  invalidDeepLink: {
    id: 'scheduleModal.invalidDeepLink',
    defaultMessage: 'Enter a valid AccordLock share link.',
  },
  failedReadFile: {
    id: 'scheduleModal.failedReadFile',
    defaultMessage: 'Could not read the selected file.',
  },
  failedParseRecipe: {
    id: 'scheduleModal.failedParseRecipe',
    defaultMessage: 'This file is not a valid playbook.',
  },
  invalidFileType: {
    id: 'scheduleModal.invalidFileType',
    defaultMessage: 'Choose a YAML file (.yaml or .yml).',
  },
  scheduleIdRequired: {
  ...
  provideValidRecipe: {
    ...
    defaultMessage: 'Choose a valid playbook source.',
  },
});
