...
const i18n = defineMessages({
  ...
  noSkillsDescription: {
    ...
    defaultMessage: 'Skills are loaded from supported personal and workspace skill folders.',
  },
  noMatchingSkills: {
  ...
  skillsDescription: {
    ...
    defaultMessage:
      'View installed skills that extend AccordLock capabilities. {shortcut} to search.',
  },
...
export default function SkillsView() {
  ...
  const loadSkills = useCallback(async () => {
    try {
      ...
      setError('AccordLock could not load skills. Try again.');
    } finally {
      setLoading(false);
    }
  }, []);
