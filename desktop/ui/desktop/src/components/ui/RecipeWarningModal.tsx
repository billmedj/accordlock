...
const i18n = defineMessages({
  ...
  firstTimeDescription: {
    ...
    defaultMessage: "You haven't run this playbook before.",
  },
  trustSource: {
    id: 'recipeWarningModal.trustSource',
    defaultMessage: 'Run it only if you trust its source.',
  },
  hiddenCharsWarning: {
    id: 'recipeWarningModal.hiddenCharsWarning',
    defaultMessage: 'Hidden characters were removed from this playbook.',
  },
  recipePreview: {
