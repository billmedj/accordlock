...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'Extensions use the Model Context Protocol (MCP) to add prompts, resources, and tools to AccordLock. {searchShortcut} to search.',
  },
  defaultNote: {
    id: 'extensionsView.defaultNote',
    defaultMessage:
      'Extensions enabled here are the default for new tasks. You can change active extensions during a task.',
  },
  addCustomExtension: {
