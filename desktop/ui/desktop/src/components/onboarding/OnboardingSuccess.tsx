...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: 'Choose a folder and describe your first task.',
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage: 'Help improve AccordLock by sharing product analytics.',
  },
  learnMore: {
  ...
  shareUsageData: {
    ...
    defaultMessage: 'Share product analytics',
  },
  getStarted: {
    id: 'onboardingSuccess.getStarted',
    defaultMessage: 'Start your first task',
  },
});
      ...
      <div className="h-full overflow-y-auto">
        <div className="flex flex-col items-center justify-center h-full p-4">
          <div className="max-w-md w-full mx-auto text-center">
            <AccordLockWordmark className="mb-10 justify-center" />
            <div className="mb-6">
            ...
            <Button
              onClick={() => onFinish(TELEMETRY_UI_ENABLED && telemetryOptIn)}
              className="w-full"
            >
