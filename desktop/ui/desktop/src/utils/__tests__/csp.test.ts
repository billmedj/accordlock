...
describe('buildConnectSrc', () => {
  ...
  it('includes only exact protected backend origins', () => {
    const result = buildConnectSrc(undefined, [
      'https://127.0.0.1:43127/status',
      'wss://127.0.0.1:43127/acp?token=redacted',
    ]);
    expect(result).toContain('https://127.0.0.1:43127');
    expect(result).toContain('wss://127.0.0.1:43127');
