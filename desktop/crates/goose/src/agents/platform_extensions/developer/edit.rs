...
pub struct FileReadParams {
    /// File path to read. AccordLock distributions require a portable path relative to the approved workspace.
    pub path: String,
...
pub struct FileWriteParams {
    /// File path to write. AccordLock distributions require a portable path relative to the approved workspace.
    pub path: String,
    pub content: String,
}
...
pub struct FileEditParams {
    /// File path to edit. AccordLock distributions require a portable path relative to the approved workspace.
    pub path: String,
    pub before: String,
    pub after: String,
}
