...
#[cfg(feature = "accordlock-distribution")]
pub(crate) const GEMINI_OAUTH_TOKEN_CACHE_KEY: &str = "GEMINI_OAUTH_TOKEN_CACHE";
...
impl TokenCache {
    ...
    fn load(&self) -> Result<Option<SetupData>> {
        match &self.backend {
            #[cfg(any(not(feature = "accordlock-distribution"), test))]
            ...
            TokenCacheBackend::Vault => {
                crate::providers::credential_vault::load(GEMINI_OAUTH_TOKEN_CACHE_KEY)
            }
        }
    }
    ...
    pub(crate) fn has_token(&self) -> bool {
        match &self.backend {
            ...
            #[cfg(feature = "accordlock-distribution")]
            TokenCacheBackend::Vault => {
                crate::providers::credential_vault::contains(GEMINI_OAUTH_TOKEN_CACHE_KEY)
                    .unwrap_or(false)
            }
        }
    }
    ...
    fn save(&self, data: &SetupData) -> Result<()> {
        match &self.backend {
            ...
            #[cfg(feature = "accordlock-distribution")]
            TokenCacheBackend::Vault => {
                crate::providers::credential_vault::save(GEMINI_OAUTH_TOKEN_CACHE_KEY, data)
            }
        }
    }
    ...
    fn clear(&self) -> Result<()> {
        match &self.backend {
            ...
            #[cfg(feature = "accordlock-distribution")]
            TokenCacheBackend::Vault => {
                crate::providers::credential_vault::delete(GEMINI_OAUTH_TOKEN_CACHE_KEY)
            }
        }
    }
}
