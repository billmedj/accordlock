...
mod tests {
    ...
    fn parses_tokenized_tool_call_with_windows_path_arguments() {
        ...
        let content = "<|tool_calls_section_begin|> <|tool_call_begin|> functions.tree:0 <|tool_call_argument_begin|> {\"path\": \"C:\\Users\\example\\projects\\goose-fork\", \"depth\": 1} <|tool_call_end|> <|tool_calls_section_end|>";
        let calls = parse_tokenized_tool_calls(content, &tools);
        ...
        assert_eq!(
            calls[0]
                ...
                .and_then(|v| v.as_str()),
            Some("C:\\Users\\example\\projects\\goose-fork")
        );
    }
